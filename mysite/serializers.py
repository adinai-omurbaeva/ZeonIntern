...
from .models import (Collection, News, AboutUsImage, PublicOffer, AboutUs, QA, QAImage, Product,
                     Advantages, Feedback, ProductImage, Footer, FooterLink, OrderUserInfo, OrderProduct,
                     Order, CartProducts)
...
class FeedbackCreationSerializer(serializers.ModelSerializer):
    class Meta:
        model = Feedback
        fields = ('name', 'phone', 'feedback_type')
